...
# Esta lista diz ao Django quais línguas o site terá
LANGUAGES = [
    ('pt-br', _('Português')),
    ('en', _('English')),
]
...
# Certifique-se que o BASE_DIR está definido corretamente no topo do arquivo
# BASE_DIR = Path(__file__).resolve().parent.parent
...
# Mude isso:
LOGIN_REDIRECT_URL = 'painel' # Se o login der certo e não soubermos para onde ir, vai para a Home
LOGIN_URL = 'login' # URL padrão de login
